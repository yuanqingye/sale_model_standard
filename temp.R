...
plot_floor_heat_uv(f1_str_m,value_name = "month_daily_uv",filter_col = "BOOTH_CODE",data = month_daily_uv_with_contract_code,mix_order = FALSE)
plot_floor_heat_uv(f2_str_m,value_name = "month_daily_uv",filter_col = "BOOTH_CODE",data = month_daily_uv_with_contract_code,mix_order = FALSE)
plot_floor_heat_uv(f3_str_m,value_name = "month_daily_uv",filter_col = "BOOTH_CODE",data = month_daily_uv_with_contract_code,mix_order = FALSE)
plot_floor_heat_uv(f4_str_m,value_name = "month_daily_uv",filter_col = "BOOTH_CODE",data = month_daily_uv_with_contract_code,mix_order = FALSE)
plot_floor_heat_uv(f5_str_m,value_name = "month_daily_uv",filter_col = "BOOTH_CODE",data = month_daily_uv_with_contract_code,mix_order = FALSE)
plot_floor_heat_uv(f6_str_m,value_name = "month_daily_uv",filter_col = "BOOTH_CODE",data = month_daily_uv_with_contract_code,mix_order = FALSE)
plot_floor_heat_uv(f7_str_m,value_name = "month_daily_uv",filter_col = "BOOTH_CODE",data = month_daily_uv_with_contract_code,mix_order = FALSE)
